...
(
  5001, 'rad140-5001', 'RAD 140 (TESTOLONE)', 'SARMs', 'sarms-2034', 
  'Stealth Labs USA', 'stealth-labs-usa-3071', 'Testolone (RAD-140)', 
  'SELECTIVE ANDROGEN RECEPTOR MODULATOR', '50 TABS x 10 MG', '20–24 HOURS', 
  'MEN 10–20 MG/DAY', 'NO', 'NO', 'NO', 'LOW', 'NO', 
  'https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?q=80&w=800&auto=format&fit=crop', 
  45.0, 80.0, 90.0, 160.0, 
  ARRAY['You will save $45.00'], 
  ARRAY['Buy 3 get 1 FREE']::TEXT[], 
  ARRAY['Domestic & International', '-50% OFF', 'Buy 3 Get 1 FREE'], 
  TRUE, 'https://www.dragonpharma.net/uploads/dragonpharmanet/anavar-10-lab-test-2026-03-26.webp', 
  TRUE, TRUE, 'RAD-140 (Testolone) is a highly effective selective androgen receptor modulator popular for adding dry muscle tissue and boosting physical endurance.'
),
(
  5002, 'mk677-5002', 'MK 677 (IBUTAMOREN)', 'SARMs', 'sarms-2034', 
  'Stealth Labs USA', 'stealth-labs-usa-3071', 'Ibutamoren (MK-677)', 
  'GROWTH HORMONE SECRETAGOGUE', '50 TABS x 25 MG', '24 HOURS', 
  'MEN 12.5–25 MG/DAY', 'NO', 'LOW', 'NO', 'NO', 'NO', 
  ...
  FALSE, NULL, 
  FALSE, TRUE, 'MK-677 (Ibutamoren) acts as a potent growth hormone secretagogue, increasing IGF-1 levels to promote appetite, sleep quality, and muscle recovery.'
),
(
  6001, 'sildenafil-6001', 'VIAGRA (SILDENAFIL 100)', 'Sexual Health', 'sexual-health-415', 
  'Generic Asia', 'generic-asia-3391', 'Sildenafil Citrate', 
  'PDE5 INHIBITOR', '30 TABS x 100 MG', '4 HOURS', 
  '50–100 MG BEFORE ACTIVITY', 'NO', 'NO', 'NO (LOWERS BP)', 'NO', 'NO', 
  'https://images.unsplash.com/photo-1550572017-edd951b55104?q=80&w=800&auto=format&fit=crop', 
  20.0, 35.0, 40.0, 70.0, 
  ARRAY['You will save $20.00'], 
  ARRAY[]::TEXT[], 
  ARRAY['Domestic & International', '-50% OFF'], 
  TRUE, 'https://www.dragonpharma.net/uploads/dragonpharmanet/anavar-10-lab-test-2026-03-26.webp', 
  TRUE, TRUE, 'Sildenafil Citrate is the active compound in Viagra, widely used to treat erectile dysfunction and enhance sexual performance and recovery times.'
),
(
  6002, 'tadalafil-6002', 'CIALIS (TADALAFIL 20)', 'Sexual Health', 'sexual-health-415', 
  'Generic Asia', 'generic-asia-3391', 'Tadalafil', 
  'PDE5 INHIBITOR', '30 TABS x 20 MG', '17.5 HOURS', 
  '10–20 MG BEFORE ACTIVITY', 'NO', 'NO', 'NO', 'NO', 'NO', 
  ...
  ARRAY['Domestic & International'], 
  FALSE, NULL, 
  FALSE, FALSE, 'Tadalafil (Cialis) is a long-lasting PDE5 inhibitor providing support for erectile dysfunction and workout pumps for up to 36 hours.'
),
(
  7001, 'clomid-7001', 'CLOMID 50', 'Post-Cycle Therapy (PCT)', 'post-cycle-therapy-3855', 
  'Axiolabs', 'axiolabs-2078', 'Clomiphene Citrate', 
  'SERM (ESTROGEN RECEPTOR ANTAGONIST)', '50 PILLS x 50 MG', '5–7 DAYS', 
  '50–100 MG/DAY', 'NO', 'NO', 'NO', 'NO', 'NO', 
  'https://images.unsplash.com/photo-1550572017-edd951b55104?q=80&w=800&auto=format&fit=crop', 
  30.0, 55.0, NULL, NULL, 
  ARRAY[]::TEXT[], 
  ARRAY[]::TEXT[], 
  ARRAY['Domestic & International'], 
  TRUE, 'https://www.dragonpharma.net/uploads/dragonpharmanet/anavar-10-lab-test-2026-03-26.webp', 
  TRUE, TRUE, 'Clomiphene Citrate (Clomid) stimulates natural testosterone production following an anabolic steroid cycle to prevent low-testosterone symptoms.'
),
(
  7002, 'nolvadex-7002', 'NOLVADEX 20', 'Post-Cycle Therapy (PCT)', 'post-cycle-therapy-3855', 
  'Axiolabs', 'axiolabs-2078', 'Tamoxifen Citrate', 
  'SERM (ESTROGEN RECEPTOR ANTAGONIST)', '50 PILLS x 20 MG', '5–7 DAYS', 
  '20–40 MG/DAY', 'NO', 'NO', 'NO', 'NO', 'NO', 
  ...
  ARRAY['Domestic & International'], 
  TRUE, 'https://www.dragonpharma.net/uploads/dragonpharmanet/anavar-10-lab-test-2026-03-26.webp', 
  FALSE, TRUE, 'Tamoxifen Citrate (Nolvadex) is a selective estrogen receptor modulator used in PCT to block estrogen receptors and restart natural testosterone production.'
),
(
  8001, 'omega3-8001', 'OMEGA-3 FISH OIL', 'Supplements', 'supplements-3050', 
  'Stealth Labs USA', 'stealth-labs-usa-3071', 'Eicosapentaenoic / Docosahexaenoic Acid', 
  'ESSENTIAL FATTY ACIDS', '120 SOFTGELS x 1000 MG', 'N/A', 
  '1–3 SOFTGELS/DAY', 'NO', 'NO', 'NO (LOWERS PRESSURE)', 'NO', 'NO', 
  ...
  ARRAY['Domestic & International'], 
  FALSE, NULL, 
  FALSE, FALSE, 'High-potency Omega-3 Fish Oil to support cardiovascular health, joint lubrication, and optimal cholesterol profiles during cycles.'
),
(
  8002, 'multivitamin-8002', 'SPORTS MULTIVITAMIN', 'Supplements', 'supplements-3050', 
  'Stealth Labs USA', 'stealth-labs-usa-3071', 'Multivitamins & Minerals', 
  'MICRONUTRIENTS', '90 TABLETS', 'N/A', 
  '1 TABLET/DAY', 'NO', 'NO', 'NO', 'NO', 'NO', 
  'https://images.unsplash.com/photo-1584017911766-d451b3d0e843?q=80&w=800&auto=format&fit=crop', 
  18.0, 28.0, NULL, NULL, 
  ARRAY[]::TEXT[], 
  ARRAY[]::TEXT[], 
  ARRAY['Domestic & International'], 
  FALSE, NULL, 
  FALSE, FALSE, 'Premium sports multivitamin supplying all key micronutrients for metabolic support, muscle repair, and immune system strength.'
),
(
  9001, 'beginner-bulk-9001', 'BEGINNER BULKING CYCLE', 'Steroid Cycles', 'cycles-1933', 
  'Dragon Pharma', 'buy-2194', 'Test Cypionate / Dianabol / Arimidex / Nolvadex', 
  'COMPLETE BULKING STACK', '12-WEEK CYCLE KIT', 'MULTIPLE', 
  'FOLLOW INCLUDED GUIDE', 'YES (POSSIBLE)', 'MODERATE', 'YES (MONITOR BP)', 'YES (ORAL DIANABOL)', 'YES (CONTROLLED)', 
  'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?q=80&w=800&auto=format&fit=crop', 
  180.0, 290.0, 360.0, 580.0, 
  ARRAY['You will save $180.00'], 
  ARRAY[]::TEXT[], 
  ARRAY['Domestic & International', '-50% OFF', 'Best Value'], 
  TRUE, 'https://www.dragonpharma.net/uploads/dragonpharmanet/anavar-10-lab-test-2026-03-26.webp', 
  TRUE, TRUE, 'The ultimate 12-week starter cycle designed to pack on massive size. Includes Testosterone Cypionate, Dianabol, aromatase inhibitors, and PCT recovery medication.'
),
(
  9002, 'advanced-cut-9002', 'ADVANCED CUTTING CYCLE', 'Steroid Cycles', 'cycles-1933', 
  'Dragon Pharma', 'buy-2194', 'Test Propionate / Tren Acetate / Winstrol / Clenbuterol', 
  'COMPLETE CUTTING STACK', '10-WEEK CYCLE KIT', 'MULTIPLE', 
  'FOLLOW INCLUDED GUIDE', 'YES', 'NO', 'YES', 'YES', 'NO', 
  'https://images.unsplash.com/photo-1579758629938-03607ccdbaba?q=80&w=800&auto=format&fit=crop', 
  240.0, 390.0, NULL, NULL, 
  ARRAY[]::TEXT[], 
  ARRAY[]::TEXT[], 
  ARRAY['Domestic & International', 'Highly Potent'], 
  TRUE, 'https://www.dragonpharma.net/uploads/dragonpharmanet/anavar-10-lab-test-2026-03-26.webp', 
  FALSE, TRUE, 'A professional 10-week cutting protocol engineered to shred body fat while maintaining dry muscle mass. Includes Testosterone, Trenbolone, Stanozolol, and Clenbuterol.'
)
)
ON CONFLICT (id) DO NOTHING;
